...
Depends on <a href="https://github.com/cmcneil/emokit">my fork</a> of qdot's emokit. Modified qdot's python interface to the EPOC, and included the modified version.
